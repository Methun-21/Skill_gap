"""
Document Processing Pipeline for AI Skill Gap Analyzer
...
class DocumentProcessor:
    ...
    def run_pipeline(self):
        ...
        st.info("This application helps you process and clean text from resumes and job descriptions (PDF, DOCX, TXT) to prepare them for skill gap analysis. Upload your documents, process them, and then download the cleaned data for further insights.")
...
def main():
    ...
    try:
        ...
        # Render the sidebar and get state, then run the pipeline.
        with st.sidebar:
